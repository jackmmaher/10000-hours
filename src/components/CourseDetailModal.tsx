    ...
    >
      ...
      >
        ...
        <div className="px-6 pb-4 border-b border-ink/5">
          {/* Course type badge and close button row */}
          ...
          {/* Title */}
          <h1 className="font-serif text-2xl text-ink mb-2">{course.title}</h1>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-6">
          {/* Description */}
          <p className="text-ink/70 leading-relaxed mb-8">{course.description}</p>
          ...
          {progress && (
            <div className="mb-8 p-4 bg-cream-deep rounded-xl">
              ...
              {isCompleted && <p className="text-xs text-moss mt-2">Course completed!</p>}
            </div>
          )}
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div
                        ...
                        ${isSessionCompleted ? 'bg-moss text-cream' : 'bg-ink/10 text-ink/50'}
                      `}
                      >
                        {isSessionCompleted ? (
                          <svg
                      ...
                      {/* Next indicator */}
                      {isNext && <span className="text-xs text-moss">Next</span>}
                    </div>
                  </button>
                )
              })}
