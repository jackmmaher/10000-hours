 ...
 *
 * Per plan spec: Users select which obstacles apply, then for each they define
 * a specific if-then response. This captures research-backed coping planning.
 *
 * CRITICAL: The minimum option must display the actual value from Screen 3,
 * not a hardcoded value. This is a verification gate requirement.
 */
...
// Predefined obstacles from the plan
...
export function ObstacleScreen({ formState, updateForm, onNext, onBack }: ScreenProps) {
  ...
  // Dynamic coping options - minimum uses actual value from Screen 3
