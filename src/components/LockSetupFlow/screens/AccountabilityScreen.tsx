 ...
 *
 * Per plan spec - this implements the full accountability flow.
 */
...
export function AccountabilityScreen({ formState, updateForm, onNext, onBack }: ScreenProps) {
  ...
  return (
    <div className="pt-8 pb-32">
      ...
      {/* Main choice - cards instead of pills for importance */}
      <motion.div
      ...
      {choice === 'text-someone' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          {/* Preview message */}
          {formState.accountabilityPhone.length >= 10 && (
            <div
            ...
            >
              ...
              <p className="text-sm" style={{ color: 'var(--text-primary)' }}>
                "You completed your {formState.unlockDurationMinutes} minute Still Hours meditation
                today ✓"
              </p>
