    ...
    <div className="h-full bg-cream overflow-y-auto" {...swipeHandlers}>
      <div className="px-6 py-8 max-w-lg mx-auto">
        ...
        <header className="mb-8">
          <h1 className="font-serif text-2xl text-indigo-deep">Saved Pearls</h1>
          <p className="text-sm text-ink/40 mt-1">{pearls.length} saved</p>
        </header>
        ...
        {!isLoading && pearls.length === 0 && (
          <div className="text-center py-16">
            <p className="font-serif text-lg text-ink/50 mb-2">No saved pearls</p>
            <p className="text-sm text-ink/30 mb-6">Save pearls from the community feed</p>
            <button
        ...
        {!isLoading && pearls.length > 0 && (
          <div className="space-y-4">
            {pearls.map((pearl) => (
              <div key={pearl.id} className="group relative bg-cream-dark/30 rounded-xl p-5">
                {/* Preserved indicator */}
                {pearl.isPreserved && (
                ...
                {/* Pearl text */}
                <p className="font-serif text-ink leading-relaxed mb-3">"{pearl.text}"</p>
