...
if (import.meta.env.DEV) {
  const devHelpers = {
    ...
    async simulateUser() {
      ...
      logger.log(`Created ${sessions.length} sessions totaling ${totalHours} hours over 33 days`)
    ...
    async resetToNewUser() {
      ...
      logger.log('Reset to new user. Refreshing...')
      location.reload()
    },
  ...
  logger.log('%c Dev Helpers Available:', 'font-weight: bold; font-size: 14px;')
  logger.log(`
